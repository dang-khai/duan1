...
class HomeController extends Controller
{
    ...
    public function postOrder(Request $request)
    {
        ...
        return redirect()->back()->with('success', 'Bạn đã đặt hàng thành công. Hãy hoàn thành việc chuyển khoản đặt cọc vào tài khoản XXXX-XXXX-XXX 
        để hoàn thành thủ tục. Từ 2 đến 3 tháng xe về thì công ty sẽ liên hệ cho bạn.');
    }
