                ...
                success: function(data) {
                    ...
                    list.forEach(element => {
                        ...
                        html += `<tr>
                                    ...
                                    <td style="width:11%">${element.sanpham['tenXe']}</td>
                                    <td style="width:11%">${element.sanpham['hangXe']['name_cate']}</td>
                                    <td style="width:11%">${element.sanpham['color']}</td>
                                    <td style="width:11%">${element.sanpham['giaXe']}</td>
