...
@section('content')
    ...
    <div class="container">
        <div class="recommended-car">
            ...
            <div id="select-new-old-car-filter" class="select-more">
                ...
                <a class="more-car" href="{{ route('product') }}">Xem thêm <img src="icon/arrow-right-more.svg" alt=""></a>
            </div>
            <div class="car-product" id="car-data">
                ...
                <a href="" class="car-box newcarfilter">
                    <div class="img-car-box-product" style="background-image: url('img/car-on-a-forest-path-photo.jpg');">
                    </div>
                    <div class="info-car">
                        <p class="status">
                            Xe mới
                ...
                <a href="" class="car-box newcarfilter">
                    <div class="img-car-box-product" style="background-image: url('img/Rectangle\ 110.png');"></div>
                    <div class="info-car">
                        <p class="status">
                            Xe mới
                        </p>
                ...
                <a href="" class="car-box newcarfilter">
                    <div class="img-car-box-product" style="background-image: url('img/pexels-pixabay-358070.jpg');">
                    </div>
                    <div class="info-car">
                        <p class="status">
                            Xe mới
                ...
                <a href="" class="car-box oldcarfilter">
                    <div class="img-car-box-product" style="background-image: url('img/hinh-anh-xe-oto-dep-3.jpg');">
                    </div>
                    <div class="info-car">
                        <p class="status">
                            Xe cũ
    ...
    <div class="container">
        <div class="car-comparison">
            ...
            <div class="info-comparison">
                <a href="" class="car-box-2">
                    <div class="img-car-box-product-2"
                        style="background-image: url('img/2022_Hyundai_Elantra_Hybrid.jpg');"></div>
            ...
            <button type="submit" class="compare-submit">Tiến Hành So Sánh</button>
        </div>
    </div>
            ...
            <div class="box-news-reviews">
                <a href="" class="box-news-reviews-1">
                    ...
                    <div class="content-bnr1">
                        ...
                        <p class="text-cbnr1">
                            Mẫu xe Mercedes-AMG GT2 vừa được giới thiệu đến công chúng và là chiếc xe đua mạnh nhất của hãng.
                        </p>
                        <div class="poster-by">
        ...
        <div class="container">
            <div class="about-us">
                ...
                <div class="content-box-au">
                    <div class="box-1-cta ">
                        <p class="text-b1cta">
                            AutoHunt là trang web hàng đầu Việt Nam về lĩnh vực ô tô. Cung cấp thông tin về giá xe ô tô, thị trường ô tô trong và ngoài nước. Danh sách các đại lý ô tô, các xưởng dịch vụ sửa chữa xe hơi các hãng xe trên cả nước để người đọc có thể tham khảo
                        </p>
                        <div class="ctn-1-b1cta">
                            <div class="b-c1b">
                                <p class="number-bc1b">150</p>
                                <div class="line-1-bc1b">
                                </div>
                                <div class="line-2-bc1b">
                                </div>
                                <p class="text-bc1b">
                                    Xe Còn Hàng
                                </p>
                    ...
                    <div class="image-about-us"
                        style="background-image: url('img/hinh-anh-xe-lamborghini-dep-nhat-34.jpg');">
    ...
    <div class="container">
        <div class="service-selection">
            <h2 class="title-service-selection">
                Lựa Chọn Dịch Vụ
            </h2>
            <div class="select-service-selection">
                ...
                <a class=" box-select-ss" href="#car-data">
        ...
        <div class="container">
            <div class="container-form-contact">
                ...
                <form class="form-cfc" action="" method="post">
                    <h2 class="title-form-contact">
                        Liên Hệ
                    </h2>
                    <p class="text-top-input first-text-ti">
                        Tên Của Bạn
                    </p>
                    <input class="input-form-ct1" type="text" name="" id=""
                        placeholder="Nhập Họ và Tên">
                    <p class="text-top-input">
                        Email
                    </p>
                    ...
                    <button class="submit-form-contact" type="submit">Gửi</button>
                </form>
            </div>
        </div>
    </div>
