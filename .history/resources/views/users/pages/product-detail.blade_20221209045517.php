            ...
            <div class="list-img-show">
                @foreach ($images as $image)
                    <div class="img-show-mini"
                        style="
                    background-image: url('{{ asset('storage') }}/{{ $image->url }}');
                ">
                    </div>
                @endforeach
            </div>
        ...
        <div class="container">
            <div class="car-information">
                <div class="car-information-block-1">
                        ...
                        <div class="block-vehicle-details">
                            ...
                            <div class="text-block-vehicle">
                                ...
                                <div class="text-1-block-vd">
                                    ...
                                    <p class="text-right-block-vd">{{ $product->status == 0 ? 'Xe mới' : 'Xe cũ' }}</p>
                                </div>
                                <div class="text-1-block-vd">
                                    <p class="text-left-block-vd">Năm SX</p>
                                    <p class="text-right-block-vd">{{ $product->year }}</p>
                                </div>
                                <div class="text-1-block-vd">
                                ...
                                <div class="text-1-block-vd">
                                    ...
                                    <p class="text-right-block-vd">{{ $product->color }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="block-vehicle-details">
                    ...
                    <form class="form-contact" action="{{ route('orders') }}" method="post">
                        @csrf
                        <div class="title-form-contact">Liên hệ mua hàng</div>
                        <div class="form-input">
                            <div class="input-name">
                                <p class="title-input-name">Tên của bạn</p>
                                <input type="text" name="name" id="" value="{{ old('name') }}" placeholder="Nhập họ và tên" />
                            </div>
                            @error('name')
                                <p>{{ $message }}</p>
                            @enderror
                            <div class="input-name">
                                ...
                                <input type="text" name="email" id="" value="{{ old('email') }}" placeholder="Nhập email" />
                            </div>
                            <div class="input-name">
                                <p class="title-input-name">Số điện thoại</p>
                                <input type="text" name="sdt" id="" value="{{ old('sdt') }}" placeholder="Nhập số điện thoại" />
                            </div>
                            <div class="input-name">
                                <p class="title-input-name">Địa chỉ</p>
                                <input type="text" name="address" id="" value="{{ old('address') }}" placeholder="Nhập địa chỉ" />
                            </div>
                            {{-- <div class="input-name">
                            ...
                            <div class="input-name input-textarea">
                                <p class="title-input-name">Tin nhắn</p>
                                <textarea placeholder="Để lại tin nhắn ở đây" value="{{ old('note') }}" name="note" id=""></textarea>
                            </div>
                            <button style="cursor: pointer" type="submit">Đồng ý đặt hàng</button>
                        </div>
                    </form>
