...
<div class="container">
    <p class="breadcrumbs">
        <a href="">Trang Chủ</a> - <a href="">Xe Mới</a> - <a href="">Tesla Model 3 Standard Range Plus</a>
    </p>    
</div>
<!-- Breadcrumbs end -->
...
<div class="slide-show-product">
    <div class="slide-show-image">
        ...
        <div class="image-show-product" style="background-image: url('img/2022_Hyundai_Elantra_Hybrid.jpg');">

        </div>
    </div>
    <div class="container">
        <div class="list-img-show">
            <div class="img-show-mini" style="background-image: url('img/2022_Hyundai_Elantra_Hybrid.jpg');">
                
            </div>
            <div class="img-show-mini" style="background-image: url('img/car-on-a-forest-path-photo.jpg');">
                
            </div>
            <div class="img-show-mini" style="background-image: url('img/customer.png');">
                
            </div>
            <div class="img-show-mini" style="background-image: url('img/hinh-anh-xe-lamborghini-dep-nhat-34.jpg');">
                
            </div>
            <div class="img-show-mini" style="background-image: url('img/hinh-anh-xe-oto-dep-3.jpg');">
                
            </div>
            <div class="img-show-mini" style="background-image: url('img/pexels-pixabay-358070.jpg');">
                
            </div>
            <div class="img-show-mini" style="background-image: url('img/suv-automobile-driving-through-foggy-and-rainy-forest-road-CAVF75458.jpg');">
...
<!-- Slide show product end -->

<!-- Car information start -->

<div class="container">
    <div class="price-car-mobile">
    <p>₫1 tỷ 410 triệu</p>
</div>
</div>
    ...
    <div class="car-information">
        <div class="car-information-block-1">
            <div class="car-description">
                <h3 class="car-description-title">
                    Mô tả xe
                </h3>
                <div class="content-description" onclick="this.classList.add('expanded')">
                    <p class="content-description-text">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas diam nam eu nulla a. Vestibulum aliquet facilisi interdum nibh blandit. Leo amet ultricies cum cras sit sed curabitur ultrices faucibus. Ultrices pellentesque ultricies semper leo maecenas. Amet, et sagittis consectetur at euismod iaculis. </br>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas diam nam eu nulla a. Vestibulum aliquet facilisi interdum nibh blandit. Leo amet ultricies cum cras sit sed curabitur ultrices faucibus. Ultrices pellentesque ultricies semper leo maecenas. Amet, et sagittis consectetur at euismod iaculis. </br>
            ...
            <form class="form-contact" action="" method="post">
                ...
                <div class="form-input">
                    ...
                    <div class="input-name input-textarea">
                        <p class="title-input-name">
                            Email
                        </p>
            ...
            <div class="location-map">
                <h3 class="title-location-map">
                    Địa điểm
                </h3>
                <p class="location-material">
                    Toà nhà Innovation, lô 24, Công viên QTSC, Quận 12, TP Hồ Chí Minh
                </p>
                <div class="map-link">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3918.455157251696!2d106.62735075098296!3d10.852944360704951!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x2328d1d1acc3b11a!2sFPT%20Polytechnic%20-%20T%C3%B2a%20F!5e0!3m2!1svi!2s!4v1669225938550!5m2!1svi!2s" width="800" height="600" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </div>  
        ...
        <div class="box-interest-calculation">
            <div class="input-box-interest">
                <div class="box">
                    ...
                    <input type="text" onchange="calculatePayments()" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" id="vehiclePrice" name="" >
                </div>
                <div class="box box2" >
                    <p class="title-box">
                        Lãi suất (%)
                    </p>
                    <input type="text" onchange="calculatePayments()" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" id="intRate" name="" >
                </div>
                <div class="box box-bottom" >
                    <p class="title-box">
                        Thời gian vay (tháng)
                    </p>
                    <input type="text" onchange="calculatePayments()" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" id="loanTerm" name="" >
                </div>
                <div class="box box2 box-bottom" >
                    <p class="title-box">
                        Tiền trả trước
                    </p>
                    <input type="text" onchange="calculatePayments()" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" id="downPayment" name="" >
                </div>
            </div>
            <div id="paymentResults" class="output-box-interest">   
                ...
                <p id="results" class="value-output">
