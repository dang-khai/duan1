                    ...
                    <form action="{{ route('post.register') }}" id="register-form" name="registration" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input id="email" type="text" value="{{ old('email') }}" name="email"
                                placeholder="Nhập email..." class="row form-control" />
                            <span class="form-message"></span>
                        </div>
                        @error('email')
                            <p style="color: red">{{ $message }}</p>
                        ...
                        <div class="form-group">
                            ...
                            <input id="repassword" type="password" name="password_confirmation"
                                placeholder="Nhập lại mật khẩu..." class="row form-control" />
                            <span class="form-message"></span>
                        </div>
                        <div class="form-group">
