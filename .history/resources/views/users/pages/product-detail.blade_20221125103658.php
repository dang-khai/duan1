    ...
    <div class="slide-show-product">
        <div class="slide-show-image">
            ...
            <div class="image-show-product"
                style="background-image: url('{{ asset('img/2022_Hyundai_Elantra_Hybrid.jpg') }}');">
            </div>
        </div>
        <div class="container">
            <div class="list-img-show">
              ...
              ">
                ...
                <div class="img-show-mini"
                    style="
                  background-image: url('{{ asset('img/hinh-anh-xe-lamborghini-dep-nhat-34.jpg') }}');
              ">
                </div>
                <div class="img-show-mini"
                    style="
                  background-image: url('{{ asset('img/hinh-anh-xe-oto-dep-3.jpg') }}');
              ">
                </div>
                <div class="img-show-mini"
                    style="
                  background-image: url('{{ asset('img/pexels-pixabay-358070.jpg') }}');
              ">
                </div>
                <div class="img-show-mini"
                    style="
                  background-image: url('{{ asset('img/suv-automobile-driving-through-foggy-and-rainy-forest-road-CAVF75458.jpg') }}');
              ">
                </div>
            </div>
        </div>
