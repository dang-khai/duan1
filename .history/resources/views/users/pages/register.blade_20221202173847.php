                ...
                <div class="form row">
                    <form action="{{ route('post.register') }}" id="register-form" name="registration" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input id="username" type="text" name="name" value="{{ old('name') }}" placeholder="Nhập tên tài khoản..."
                        ...
                        <div class="form-group">
                            ...
                            <input id="email" type="text" value="{{ old('email') }}" name="email" placeholder="Nhập email..."
                                class="row form-control" />
                            <span class="form-message"></span>
                        </div>
                        @error('email')
