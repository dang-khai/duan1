...
@section('content')
    ...
    <div class="container">
        <p class="breadcrumbs">
            <a href="">Trang Chủ</a> - <a href="">Xe Mới</a> - <a href="">Tesla Model 3 Standard Range
                Plus</a>
        </p>
    </div>
    <!-- Breadcrumbs end -->
        ...
        <div class="container">
            <div class="list-img-show">
                ...
                <div class="img-show-mini"
                    style="background-image: url('img/suv-automobile-driving-through-foggy-and-rainy-forest-road-CAVF75458.jpg');">
                ...
                <div class="car-description">
                    ...
                    <div class="content-description" onclick="this.classList.add('expanded')">
                        <p class="content-description-text">
                            ...
                            tristique. Libero aliquam pellentesque laoreet dui pulvinar facilisis. Id lectus mauris senectus
                            sodales porta malesuada tincidunt et. Quam dui nulla venenatis suscipit nulla lectus volutpat,
                            augue purus. Sed condimentum parturient maecenas viverra pulvinar leo augue nunc.
                        </p>
...
@section('js')
    <script>
        function calculatePayments() {
            ...
            var calc = ((monInt + (monInt / (Math.pow((1 + monInt), months) - 1))) * (amount - (totalDown || 0))).toFixed(
            2);
