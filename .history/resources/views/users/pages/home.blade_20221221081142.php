    ...
    <div class="container">
        <div class="recommended-car">
            ...
            <div class="car-product">
                <span id="new-data"></span>
                <span id="old-data"></span>
                ...
                success: function(data) {
                    ...
                    list.forEach(element => {
                        if (element.status == 'Xe mới') {
                            newCar +=
                                `<a href="/product/${element.slug}/id-${element.id}" class="car-box newcarfilter">
    ...
    <div class="info-car">
        ...
        <div class="reviews">
            ...
            <p>(12 Đánh giá)</p>
                            ...
                            oldCar +=
                                `<a href="/product/${element.slug}/id-${element.id}" class="car-box oldcarfilter">
    <div class="img-car-box-product" style="background-image: url('{{ asset('storage') }}/${element.hinhXe[0]['url']}');"></div>
    <div class="info-car">
        <p class="status">
            ${element.status}
        ...
        <div class="reviews">
            ...
            <p>(12 Đánh giá)</p>
                    ...
                    $('#new-data').html(newCar);
                    $('#old-data').html(oldCar);
                }
            })
        });
    </script>
