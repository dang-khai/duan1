...
@section('content')
    <section>
                ...
                <div class="col-md-3">
                    <div class="card text-white bg-secondary mb-3" style="max-width: 20rem;">
                        <div class="card-body container">
                            <img src="{{ asset('storage') . '/' . $image->url }}" class="card-img"
        ...
        <div class="d-flex">
            ...
            <form method="POST" action="{{ route('admin_addImage', request()->route('id')) }}"
                enctype="multipart/form-data">
                @csrf
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addModal">Thêm
                    ảnh</button>
                <!-- modal add img -->
