            ...
            @foreach ($orders as $order)
                <tr>
                    ...
                    <td style="width:15%"><a class="btn btn-primary"
                        ...
                        <form id="update-form" action="http://127.0.0.1:8000/logout" method="POST" class="d-none">
                            <input type="hidden" name="_token" value="1mnGTkFlOnePvS01PrOJ3kZXcFJ4lUyw1RaFKrok">
                        </form>
